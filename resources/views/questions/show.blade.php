                ...
                <div class="card-body">
                    ...
                    <div class="media text-justify">
                        <div class="d-flex flex-column vote-controls ">
                            ...
                            {{-- vote down --}}
                            <a title="This question is not useful" class="vote-up {{ Auth::guest() ? 'off' : '' }}" onclick="event.preventDefault(); document.getElementById('down-vote-question-{{ $question->id }}').submit();">
